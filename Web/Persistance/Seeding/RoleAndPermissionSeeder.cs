...
public class RoleAndPermissionSeeder : IDataSeeder
{
    ...
    //         .ToArray();
    //
    //     modelBuilder.Entity<Permission>().HasData(rolePermissions);
    // }
    //
    // private static Permission CreateRolePermissionWithId(int id, PermissionType permission, int roleId)
    // {
    //     var rolePermission = Permission.CreateExisting(id, permission);
